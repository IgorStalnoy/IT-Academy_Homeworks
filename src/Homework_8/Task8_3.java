...
public class Task8_3 {
    public static void main(String[] args) {
        ...
        String[] punctuationMarks1 = text1.split("\\p{P}"); //исходный вариант, считает неверно при наличии совпадения в начале строки(прикол сплита, так и должно быть)
        System.out.println("There are " + punctuationMarks1.length + " punctuation marks in the text");

        String[] punctuationMarks2 = text1.replaceAll("\\P{P}", "").split("");
        System.out.println("There are " + punctuationMarks2.length + " punctuation marks in the text");

        System.out.println("There are " + text1.replaceAll("\\P{P}", "").length() + " punctuation marks in the text");
    }
}
